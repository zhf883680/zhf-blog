...
//                   <div class="pswp__counter"></div>
//                   <button class="pswp__button pswp__button--close" title="Close (Esc)"></button>
//                  <button class="pswp__button pswp__button--share" title="Share"></button>   分享按钮
//                <button class="pswp__button pswp__button--fs" title="Toggle fullscreen"></button> 全屏按钮
//               <button class="pswp__button pswp__button--zoom" title="Zoom in/out"></button> 放大按钮 
//                   <div class="pswp__preloader">
//                       <div class="pswp__preloader__icn">
//                           <div class="pswp__preloader__cut">
//                               <div class="pswp__preloader__donut"></div>
